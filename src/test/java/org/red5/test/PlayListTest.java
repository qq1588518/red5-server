...
public class PlayListTest {
    ...
    public void test() {
        ...
        assertTrue(true);
        /*
         * // init service service.init(streamName); // get count int count = service.getSegmentCount(streamName); // make sure there are 4 available segments assertTrue(count == 4);
         * dumpPlaylist(); service.createLastSegment(); count = service.getSegmentCount(streamName); assertTrue(count == 5); dumpPlaylist(); service.removeFirstSegment(); count =
         * service.getSegmentCount(streamName); assertTrue(count == 4); dumpPlaylist();
         */
    }
