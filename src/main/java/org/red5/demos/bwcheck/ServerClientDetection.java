...
public class ServerClientDetection implements IPendingServiceCallback, IBandwidthDetection {
    ...
    protected static Logger log = LoggerFactory.getLogger(ServerClientDetection.class);
    ...
    public void resultReceived(IPendingServiceCall call) {
        ...
        /*
         * else if (count == 2 && (timePassed < 2000)) { pakSent.add(now); sent++; cumLatency++; this.callBWCheck(this.client.getAttribute("payload")); }
         */
